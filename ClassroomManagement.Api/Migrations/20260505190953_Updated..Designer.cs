...
namespace ClassroomManagement.Api.Migrations
{
    ...
    [Migration("20260505190953_Updated.")]
            ...
            modelBuilder.Entity("ClassroomManagement.Api.Models.Domains.TeacherAssignment", b =>
                {
                    ...
                    b.Property<int>("LevelTermSectionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassroomManagement.Api.Models.Domains.TeacherAssignment", b =>
                {
                    ...
                    b.HasOne("ClassroomManagement.Api.Models.Domains.LevelTermSection", "LevelTermSection")
                        .WithMany("AssignedTeachers")
                        .HasForeignKey("LevelTermSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
